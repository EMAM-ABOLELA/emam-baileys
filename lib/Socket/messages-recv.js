...
const makeMessagesRecvSocket = (config) => {
    ...
    const handleMexNewsletterNotification = (id, node) => {
        ...
        if (operation === 'update') {
        	contentPath = content.data['xwa2_newsletter_metadata_update']
            ...
            if (operation === 'promote') {
            	action = 'promote'
                contentPath = content.data['xwa2_newsletter_promote_participant']
            } else {
            	action = 'demote'
                contentPath = content.data['xwa2_newsletter_demote_participant']
            }
