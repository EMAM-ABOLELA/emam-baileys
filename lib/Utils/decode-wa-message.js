...
function decodeMessageNode(stanza, meId, meLid) {
    ...
    const participant = stanza.attrs.participant_pn ? stanza.attrs.participant_pn : stanza.attrs.participant;
    ...
    const remoteJid = !isJidGroup(chatId) 
        ? (stanza.attrs.sender_pn || stanza.attrs.participant_pn || chatId)
        : chatId;
